...
export class CategoriaService implements OnModuleInit {
  ...
  async carregarCache() {
    ...
    this.logger.log(
      `Carregadas ${this.categoriasCache.length} categorias em memória.`,
    );
  }
    ...
    const seedData = [
      {
        ...
        subcategorias: [
          ...
          },
          {
            ...
            palavrasChave: ['cereal', 'cereais', 'corn flakes', 'granola'],
          },
        ],
      },
      {
        ...
        subcategorias: [
          ...
          {
            nome: 'Cuidados com Cabelo',
            palavrasChave: ['tintura', 'gel', 'géls', 'pomada', 'spray'],
          },
          {
            nome: 'Maquiagem',
            palavrasChave: [
      ...
      },
      {
        ...
        subcategorias: [
          {
            nome: 'Açúcar e Adoçantes',
            palavrasChave: ['açúcar', 'acucar', 'adoçante', 'adocante'],
          },
          {
          ...
          {
            nome: 'Café e Achocolatados',
            palavrasChave: ['café', 'cafe', 'achocolatado', 'cacau'],
          },
          {
            nome: 'Matinais e Sobremesas',
            palavrasChave: [
              'gelatina',
              'pudim',
              'mistura para bolo',
      ...
      },
      {
        ...
        subcategorias: [
          ...
          },
          {
            ...
            palavrasChave: ['marmitex', 'pote descartável', 'pote descartavel'],
          },
          {
            nome: 'Mobiliário Plástico',
            palavrasChave: [
              'cadeira de plástico',
              'cadeira de plastico',
              'mesa de plástico',
